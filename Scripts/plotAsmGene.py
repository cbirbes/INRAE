...
ax.set_ylabel('Occurences', labelpad=15, color='#333333',weight='bold',size='17')
ax.set_title('ASMGene score', pad=15, color='#333333', weight='bold', size='25')
plt.xticks(x,xticks)
plt.tick_params(axis='both', labelsize=14)
plt.legend(["Full and single copy","Full and duplicated","Fragmented",">50% match size",">10% match size","<10% match size"],loc='upper center',ncol=2,labelspacing=0.15,fontsize='18',frameon=False)
